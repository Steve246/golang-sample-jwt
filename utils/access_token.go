...
type Token interface {
	...
	StoredAccessToken(userName string, tokenDetail *model.TokenDetails) error
...
func (t *token) StoredAccessToken(userName string, tokenDetail *model.TokenDetails) error {
